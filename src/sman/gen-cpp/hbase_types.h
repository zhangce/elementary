...
class TRegionInfo {
 public:
  ...
  struct __isset {
    __isset() : startKey(false), endKey(false), id(false), name(false), version(false), serverName(false), port(false) {}
    bool startKey;
    bool endKey;
    bool id;
    bool name;
...
class Mutation {
 public:
  ...
  struct __isset {
    __isset() : isDelete(false), column(false), value(false), writeToWAL(false) {}
    bool isDelete;
    bool column;
    bool value;
    bool writeToWAL;
...
class TIncrement {
 public:
  ...
  struct __isset {
    __isset() : table(false), row(false), column(false), ammount(false) {}
    bool table;
    bool row;
    bool column;
    bool ammount;
...
class TScan {
 public:
  ...
  struct __isset {
    __isset() : startRow(false), stopRow(false), timestamp(false), columns(false), caching(false), filterString(false) {}
    bool startRow;
    bool stopRow;
    bool timestamp;
    bool columns;
